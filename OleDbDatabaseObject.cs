...
namespace CodedThought.Core.Data.OleDb
{
    ...
    public class OleDbDatabaseObject : DatabaseObject, IDatabaseObject
    {
        ...
        public OleDbDatabaseObject() : base() => _connection = new();
        ...
        /// </summary>
        public override IDbConnection Connection => _connection == null ? (OleDbConnection) base.Connection : (OleDbConnection) _connection;
        ...
        public override string GetDefaultSessionSchemaNameQuery() => "SELECT DATABASE()";
